const stories = [
  ...
  { text: "right click to get them floating around in the void.", trigger: null },
  ...
  { text: "spawn particles near cyclone", trigger: null },
  ...
  { text: "press S for slither mode.", trigger: "s"},
  { text: "reptile vibes frr", trigger: null},
  { text: "press S to exit slither mode.", trigger: "s"},
