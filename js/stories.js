const stories = [
  ...
  { text: "right click to create a shockwave.", trigger: null },
  { text: "press G to flip gravity.", trigger: "g" },
  { text: "press G again to turn it off.", trigger: "g" },
  { text: "press B for black hole mode.", trigger: "b" },
  ...
  { text: "press M to turn it off.", trigger: "m" },
